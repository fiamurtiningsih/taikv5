...
def masuk():
        ...
        try:
                ...
                cek = input("[\033[1;32m>\033[0m Masukan Cookie kontl:v : ")
        cek = {"cookie":cek}
...
if __name__ == '__main__':
        try:
                ...
                kuki = {'cookie':kukis}
                os.system("clear")
                print(' \033[1;31m______		  		    _____	  _____ 	_____ ')
				print('\033[1;31m\\ _____    ||		 ||	||____||	||____	||____|| ')
				print("\033[1;31m   \\	 	 ||		 ||	||		||	||____	||   	|| ")
				print("\033[1;37m __\\		||_____||	||		||	||____	||____|| ")
				print('\033[1;37m___\\ 	  ||_____||	||		||	||____	||____||v⁴. 0 ')
                print('\033[1;34m=======================================')
                ...
                if tanya =="":
                        ...
                        print("# Hanya bisa 500 id yg di dapatkan ")
                        grab = input("# ID group : ")
                ...
                if check != 0 or result != 0:
                        ...
                        exit("# terima kasih menggunakan tool ini kontoll:v")
                else:
                        print("\n# Selesai anjing")
                        exit("# tidak ada hasil kebanyakan cmly lu:v")
